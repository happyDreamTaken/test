...
class ChangeMyMobiePhone: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigateBar.titleLabel.text = "更换手机号"
...
extension ChangeMyMobiePhone {
    ...
    fileprivate func setup() {
        ...
        oldPhoneTextField.placeholder = "原手机号"
    ...
    @objc func loginButtonDidClick() {
        ...
        //校验验证码
        IvyGateServerAPI.shared.verficateOldPhone(phone: mobile, verfyCode: codeNumber) { (res, error) in
            guard let json = res else {
                return
            }
            guard json["code"].intValue == 1 else {
            ...
            DispatchQueue.main.async {
                 NavigationController.shared.pushViewController(ConfirmMobieViewController(), animated: false)
            }
        }
